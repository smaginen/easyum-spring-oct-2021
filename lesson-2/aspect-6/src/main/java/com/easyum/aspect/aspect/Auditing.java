package com.easyum.aspect.aspect;
...
public class Auditing {
	...
	@Before("execution(* com.easyum.aspect.service.TransferService.transfer(..))")
	...
	@AfterReturning("execution(* com.easyum.aspect.service.TransferService.transfer(..))")
	public void success(){
        System.out.println("bank successfully transferred amount");
    }
	//After failed transfer service
	@AfterThrowing("execution(* com.easyum.aspect.service.TransferService.transfer(..))")
